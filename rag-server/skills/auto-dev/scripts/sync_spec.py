#!/usr/bin/env python3
"""
Spec Sync — splits DEV_SPEC.md into chapter files under auto-dev/references/.
...
def sync(force: bool = False):
    skill_dir = Path(__file__).parent.parent          # auto-dev/
    repo_root = skill_dir.parent.parent               # rag-server root
