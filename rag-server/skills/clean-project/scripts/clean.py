...
Usage:
    python skills/clean-project/scripts/clean.py          # dry-run (show what would be deleted)
    python skills/clean-project/scripts/clean.py --execute # actually delete
    python skills/clean-project/scripts/clean.py --execute --keep-data  # keep data/ & logs/
"""
...
REPO_ROOT = Path(__file__).resolve().parents[3]  # skills/clean-project/scripts → repo root
