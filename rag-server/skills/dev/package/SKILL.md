...
```powershell
python skills/dev/package/scripts/clean.py
```
...
python skills/dev/package/scripts/clean.py --execute

# Keep data and logs
python skills/dev/package/scripts/clean.py --execute --keep-data

# Skip secret sanitization
python skills/dev/package/scripts/clean.py --execute --no-sanitize
```
...
| Test artifacts | `skills/_sources/claude/test-skill/`, `test_data/chroma/` |
| Skill caches | `skills/dev/auto-coder/.spec_hash`, `skills/_sources/claude/auto-coder/.spec_hash` |
