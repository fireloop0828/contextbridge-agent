...
Usage:
    python skills/dev/package/scripts/clean.py          # dry-run (show what would be deleted)
    python skills/dev/package/scripts/clean.py --execute # actually delete
    python skills/dev/package/scripts/clean.py --execute --keep-data  # keep data/ & logs/
"""
...
REPO_ROOT = Path(__file__).resolve().parents[4]  # skills/dev/package/scripts → repo root
...
REMOVE_DIRS: list[str] = [
    ...
    # Test data caches
    "test_data/chroma",
    # Claude skill test artifacts (legacy)
    "skills/_sources/claude/test-skill",
]
...
REMOVE_FILES: list[str] = [
    ...
    "secrets.yaml",
    # Skill caches 
    "skills/dev/auto-coder/.spec_hash",
    "skills/_sources/claude/auto-coder/.spec_hash",
    # Config backups
