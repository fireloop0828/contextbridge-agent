...
All files under `skills/dev/auto-coder/references/`:
...
```powershell
python skills/dev/auto-coder/scripts/sync_spec.py
```

Then read the schedule file to get task statuses:
- Read `skills/dev/auto-coder/references/06-schedule.md`
...
1. **Read relevant spec** from `skills/dev/auto-coder/references/`:
...
2. **Re-sync**: `python skills/dev/auto-coder/scripts/sync_spec.py --force`
3. **Show summary & ask**:
