---
name: mock-interview
description: "本项目模拟技术面试：可选面试风格（FAST/DEEP/CODE/HARD/MIX）、掷骰选题防重复、三方向深度追问、生成面试报告（含参考答案与评分）。用户说「模拟面试」「面试练习」「帮我面试」「考我」「开始面试」「mock interview」「interview practice」时使用。"
---
...
3. `references/report_template.md` — **仅在阶段 3 生成报告时读取**，含报告模板、参考答案和评分细则

---

## 阶段 0.5：面试官风格选择（开场第一步）
...
**参考答案、包装识别点评、五维度评分** — 仅在阶段 3 生成，面试过程中不提前透露。
