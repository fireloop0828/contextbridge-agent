...
Usage:
    python skills/run-qa/scripts/qa_config.py show          # List profiles
    python skills/run-qa/scripts/qa_config.py check         # Verify credentials
    python skills/run-qa/scripts/qa_config.py apply <name>  # Apply a profile
    python skills/run-qa/scripts/qa_config.py restore       # Restore backup
