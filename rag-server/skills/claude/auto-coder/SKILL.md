...
All files under `skills/_sources/claude/auto-coder/references/`:
...
```powershell
python skills/_sources/claude/auto-coder/scripts/sync_spec.py
```

Then read the schedule file to get task statuses:
- Read `skills/_sources/claude/auto-coder/references/06-schedule.md`
...
1. **Read relevant spec** from `skills/_sources/claude/auto-coder/references/`:
...
2. **Re-sync**: `python skills/_sources/claude/auto-coder/scripts/sync_spec.py --force`
3. **Show summary & ask**:
