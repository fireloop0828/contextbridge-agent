...
> After completing a section, run `python skills/_sources/claude/qa-tester/scripts/qa_validate_notes.py`.
...
```
Empty          → python skills/_sources/claude/qa-tester/scripts/qa_bootstrap.py clear
Baseline       → python skills/_sources/claude/qa-tester/scripts/qa_bootstrap.py baseline
DeepSeek       → python skills/_sources/claude/qa-tester/scripts/qa_config.py apply deepseek
Rerank_LLM     → python skills/_sources/claude/qa-tester/scripts/qa_config.py apply rerank_llm
NoVision       → python skills/_sources/claude/qa-tester/scripts/qa_config.py apply no_vision
InvalidKey     → python skills/_sources/claude/qa-tester/scripts/qa_config.py apply invalid_llm_key
InvalidEmbedKey→ python skills/_sources/claude/qa-tester/scripts/qa_config.py apply invalid_embed_key
Any            → no state change needed
```

After config-profile tests → `python skills/_sources/claude/qa-tester/scripts/qa_config.py restore`
Check state → `python skills/_sources/claude/qa-tester/scripts/qa_bootstrap.py status`
...
```
python skills/_sources/claude/qa-tester/scripts/qa_multistep.py <TEST_ID>
```
...
```
python skills/_sources/claude/qa-tester/scripts/qa_validate_notes.py
```
