...
Usage:
    python skills/_sources/claude/qa-tester/scripts/qa_config.py show          # List profiles
    python skills/_sources/claude/qa-tester/scripts/qa_config.py check         # Verify credentials
    python skills/_sources/claude/qa-tester/scripts/qa_config.py apply <name>  # Apply a profile
    python skills/_sources/claude/qa-tester/scripts/qa_config.py restore       # Restore backup
