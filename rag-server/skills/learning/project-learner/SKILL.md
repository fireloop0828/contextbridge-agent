...
1. Try reading `skills/learning/project-learner/references/LEARNING_PROGRESS.md`
...
Update `skills/learning/project-learner/references/LEARNING_PROGRESS.md`.
...
| File | Purpose |
|------|---------|
| `skills/learning/project-learner/references/LEARNING_PROGRESS.md` | Persistent learning state (45 sub-topics) |
