...
from src.libs.loader.loader_factory import get_loader_for_path
...
class IngestionPipeline:
    ...
    def __init__(
        ...
        # Stage 2: Loader (per-file selection in run() via loader_factory)
        self._image_storage_dir = str(resolve_path(f"data/images/{collection}"))
        logger.info("  ✓ Document loaders ready (PDF, TXT)")
