...
Usage:
    # Process a single PDF or TXT file
    python scripts/ingest.py --path documents/report.pdf --collection contracts
    python scripts/ingest.py --path documents/guide.txt --collection guides
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to file or directory to ingest. "
             "If directory, processes all PDF and TXT files recursively."
    )
